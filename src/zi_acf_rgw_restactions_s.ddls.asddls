@EndUserText.label: 'REST Action'
@AccessControl.authorizationCheck: #MANDATORY
@Metadata.allowExtensions: true
define view entity ZI_ACF_RGW_RESTACTIONS_S
  as select from zacf_rgwcfr
  association to parent ZI_ACF_RGW_RestActions as _RESTActions on $projection.SingletonID = _RESTActions.SingletonID
{
  key app as App,
